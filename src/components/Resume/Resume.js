      ...
      <Container>
        ...
        <Row className="resume">
          ...
          <Col md={6} className="resume-right">
            ...
            <Resumecontent
              title="Azure Fundamental (AZ-900) | (Microsoft)"
              content={[
                "Basic knowledge of cloud services and how those services are provided with Azure",
              ]}
            />
            <Resumecontent
              title="Data Structure and Algorithm | (Geeks for Geeks)"
              content={[
                "Completed this 8 week self paced course that contains data structure and algorithms lectures, coding questions for practice & assessment tests ",
              ]}
            />
          </Col>
        </Row>
